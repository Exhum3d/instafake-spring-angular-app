...
public class JwtTokenService {
    ...
    public String generateToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create()
                ...
                .withExpiresAt(new Date(System.currentTimeMillis() + Constants.JWT_EXPIRATION_2WEEKS))
    ...
    private String[] getClaimsFromToken(String token) {
        JWTVerifier jwtVerifier = getJwtVerifier();
        return jwtVerifier.verify(token).getClaim(Constants.AUTHORITIES).asArray(String.class);
    }
    ...
    private JWTVerifier getJwtVerifier() {
        ...
        try {
            ...
            throw new JWTVerificationException(Constants.TOKEN_UNVERIFIABLE);
        }
        return jwtVerifier;
    }
}
